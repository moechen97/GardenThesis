...
namespace Planting
{
    public class UnlockableIconDictionaryScript : MonoBehaviour, ISerializationCallbackReceiver
    {
        [SerializeField]
        public UnlockableIconDictionaryScriptaleObject dictionaryData;
        [SerializeField]
        private List<PlantType> keys = new List<PlantType>();
        [SerializeField]
        private List<GameObject> values = new List<GameObject>();

        [HideInInspector] public Dictionary<PlantType, GameObject> myDictionary = new Dictionary<PlantType, GameObject>();
        ...
        public Dictionary<PlantType, GameObject> DeserializeDictionary()
        {
            myDictionary = new Dictionary<PlantType, GameObject>();
