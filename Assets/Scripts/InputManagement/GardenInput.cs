    ...
    public class GardenInput : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            else if(rotatingScreen)
            {
                ...
                //Fix rotation point
                //FixRotationPoints(); 
                camFocusPoint.transform.localEulerAngles = new Vector3(ClampAngle(camFocusPoint.transform.localEulerAngles.x, 0F, 8F), camFocusPoint.transform.localEulerAngles.y, camTransform.localEulerAngles.z);
